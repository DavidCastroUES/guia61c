...
var fila="<tr><td class='id'></td><td class='foto'></td><td class='price'></td><td class='title'></td><td class='description'></td><td class='category'></td></tr>";
  ...
  function codigoCat(catstr) {
	...
	function listarProductos(productos) {
	  ...
	  var ids,titles,prices,descriptions,categories,fotos,opciones;
...
function obtenerProductos() {
	  fetch('https://retoolapi.dev/KonFal/productos')
            .then(res=>res.json())
            .then(data=>{
				productos=data;
				productos.forEach(
...
function agregarProducto(){
	var formulario = document.forms['agregar'];
	...
	var nuevoProducto = {image:imagen,price:precio,title:titulo,description:descripcion,category:categoria};
	var result;
	fetch("https://retoolapi.dev/KonFal/productos",
			{ method:"POST",
